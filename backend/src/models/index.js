 ...
 */
const ItemManager = require('./models.exemples/ItemManager')
const CharacterManager = require('./models.exemples/CharacterManager')
const HouseManager = require('./models.exemples/HouseManager')
const VilleManager = require('./VilleManager')
const QuartierManager = require('./QuartierManager')
const OeuvreManager = require('./OeuvreManager')
const UtilisateurHasOeuvreManager = require('./UtilisateurHasOeuvreManager')
const UtilisateurManager = require('./UtilisateurManager')
const ArticleManager = require('./ArticlesManager.js')
/* 
...
models.ville = new VilleManager()
models.ville.setDatabase(pool)
models.quartier = new QuartierManager()
models.quartier.setDatabase(pool)
models.oeuvre = new OeuvreManager()
models.oeuvre.setDatabase(pool)
models.utilisateurHasOeuvre = new UtilisateurHasOeuvreManager()
models.utilisateurHasOeuvre.setDatabase(pool)
