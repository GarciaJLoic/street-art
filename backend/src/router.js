...
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX  Route de base  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX  Routes articles  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
router.get('/articles/new', (req, res) => {
  const article = {
    titre: '',
    // date: new Date.localeDateToString(),
    date: '',
    photo: '',
    texte: '',
  }
...
router.post('/articles/new', articlesController.newArticle)
