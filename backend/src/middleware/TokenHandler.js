...
const signInTokenCreation = async (req, res, next) => {
  try {
...
const checkUser = (req, res, next) => {
  ...
  const identification = { pseudo: null, email: null }
  ...
  try {
    ...
    decodedToken.id.includes('@')
      ? (identification.email = decodedToken.id)
      : (identification.pseudo = decodedToken.id)
...
const refresh = async (req, res, next) => {
  try {
    ...
    const accessToken = createAccessToken(utilisateur.pseudo)
