...
INSERT INTO `oeuvre` VALUES (11,NULL,10,'0f78ca4b-76ed-4aa6-aca8-1a0330e36a85-BGAll.svg',44.84962940074958,-0.5608069651355938,0,1,2),(12,NULL,35,'12.jpg',44.838878675776904,-0.5802154541015626,0,1,3),(13,NULL,10,'13.jpg',44.8068854578942,-0.6232769914559688,0,1,4),(14,NULL,45,'14.jpg',44.81620173806237,-0.5965962395082577,0,1,5),(15,NULL,25,'15.jpg',44.810210005863496,-0.5432323884474753,0,1,6),(16,NULL,20,'16.jpg',44.79466786574708,-0.6182431150180463,0,1,7),(17,NULL,10,'17.jpg',44.85303197992082,-0.5723105393951187,0,1,8),(18,NULL,15,'18.jpg',44.835699,-0.570443,0,1,9),(19,NULL,10,'19.jpg',44.80244172430585,-0.5578321664957506,0,1,10),(20,NULL,30,'20.jpg',44.82894086330347,-0.603291789936389,0,1,5),(21,NULL,50,'21.jpg',44.82656547827471,-0.5653309995596228,0,0,11);
...
CREATE TABLE `quartier` (
  ...
  CONSTRAINT `fk_quartier_ville1` FOREIGN KEY (`ville_id`) REFERENCES `ville` (`id`) ON DELETE CASCADE;
...
INSERT INTO `quartier` VALUES (0,'ADMIN',0,0,0,NULL),(2,'Bastide Niel',44.84561144422572,-0.5578021332009533,1,NULL),(3,'Bacalan',44.872763736236465,-0.548930291154818,1,NULL),(4,'Le Burck',44.81501290413744,-0.6397140848018117,1,NULL),(5,'Saint Augustin',44.827263932469066,-0.6074846300039526,1,NULL),(6,'Le prèche',44.812508973555936,-0.5467813333074922,1,NULL),(7,'Montaigne',44.79600314025957,-0.6168865368936665,1,NULL),(8,'Chartrons',44.858264173482326,-0.5670218539579241,1,NULL),(9,'Victor Hugo',44.840508475087574,-0.5719463981394894,1,NULL),(10,'Bègles',44.812036167446735,-0.5441236702691535,1,NULL),(11,'Nansouty',44.81939885602836,-0.5708871922829272,1,NULL),(17,'Les Jacobins',48.00916153816375,0.20393371582031253,2,NULL),(18,'Jean Jaurès',47.996642079446815,0.2026462554931641,2,NULL),(19,'Les Maillets',48.018750077357865,0.2060794830322266,2,NULL);
...
INSERT INTO `utilisateur` VALUES (1,'boobaA','kaaris','jean loic','jl123',NULL,'jl@gmail.com','bidon',0,1),(2,'bob l\'éponge','bob','brice','br123',NULL,'br@gmail.com','bidon1',0,2),(3,'booba','ourson','booba','$argon2id$v=19$m=65536,t=3,p=4$cifqGcHAcckeDK1T8JPm+Q$H98KakpJZWq6STY/1W5KXxr5uOKoFD5tY9HVd8LBGadugv//wZuXiQ',NULL,'booba@ourson.lol','bidon',1797,2);
...
CREATE TABLE `utilisateur_has_oeuvre` (
  ...
  CONSTRAINT `fk_utilisateur_has_Oeuvre_Oeuvre1` FOREIGN KEY (`oeuvre_id`) REFERENCES `oeuvre` (`id`) ON DELETE CASCADE,
...
INSERT INTO `utilisateur_has_oeuvre` VALUES (1,11,1,0),(2,11,0,1),(2,12,1,0),(2,13,0,0),(2,14,0,0),(2,15,1,0),(2,16,1,0),(2,17,0,0),(2,18,0,0),(2,19,0,1),(2,20,0,0),(2,21,0,0),(3,11,0,0),(3,12,0,0),(3,13,0,0),(3,14,1,0),(3,15,0,0),(3,16,0,0),(3,17,0,0),(3,18,0,0),(3,19,0,0),(3,20,1,0),(3,21,0,0);
...
INSERT INTO `ville` VALUES (0,'ADMIN',0,0),(1,'BORDEAUX',44.83862654144651,-0.5825808773447223),(2,'LE MANS',48.00904669455433,0.19723892211914062);
...
-- Dump completed on 2023-03-29 17:33:45